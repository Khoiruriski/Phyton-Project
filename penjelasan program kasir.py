...
class Kasir:
    def __init__(self):
        self.barang = []  # Daftar produk dan layanan yang tersedia
        self.keranjang = []  # Item yang dipilih oleh pelanggan
    ...
    # Method untuk menambahkan barang baru ke daftar produk dan layanan
    ...
    # Method untuk memperbarui stok barang
    ...
    # Method untuk melakukan checkout dan mencetak struk pembelian
    def checkout(self):
        print("\n---------- Struk Pembelian ----------\n")
        total_harga = 0
    ...
    # Method untuk menyimpan data barang ke dalam file JSON
    ...
    # Method untuk memuat data barang dari file JSON
    ...
    # Method untuk menampilkan daftar produk dan layanan
    ...
    def menu_kasir(self):
        while True:
            ...
            if pilihan == "1":
                ...
                print("\nPilihan tidak tersedia, silahkan pilih nomor menu dengan benar, Terimakasih !")
